...
import com.pinnoocle.fruitindustryoptimization.receiver.NetUtils;
import com.pinnoocle.fruitindustryoptimization.receiver.NetworkChangeEvent;
import com.pinnoocle.fruitindustryoptimization.receiver.NetworkConnectChangedReceiver;
    ...
    public void initRed() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                    | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
            window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            window.setStatusBarColor(getResources().getColor(R.color.light_red));
        }
    }
